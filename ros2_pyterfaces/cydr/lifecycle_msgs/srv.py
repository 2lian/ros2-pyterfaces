...
class ChangeState_Event(IdlStruct):
...
class GetAvailableStates_Request(IdlStruct):
    __idl_typename__ = 'lifecycle_msgs/srv/GetAvailableStates_Request'

class GetAvailableStates_Response(IdlStruct):
...
class GetAvailableStates(IdlStruct):
...
class GetAvailableStates_Event(IdlStruct):
    __idl_typename__ = 'lifecycle_msgs/srv/GetAvailableStates_Event'
    __unsupported_reason__ = 'request is a collection of messages, which cydr does not support'
    pass

class GetAvailableTransitions_Request(IdlStruct):
    __idl_typename__ = 'lifecycle_msgs/srv/GetAvailableTransitions_Request'

class GetAvailableTransitions_Response(IdlStruct):
...
class GetAvailableTransitions(IdlStruct):
...
class GetState_Event(IdlStruct):
