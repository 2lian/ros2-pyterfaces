...
class ByteMultiArray(JitStruct):
...
class Float32MultiArray(JitStruct):
...
class Float64MultiArray(JitStruct):
...
class Int16MultiArray(JitStruct):
...
class Int32MultiArray(JitStruct):
...
class Int64MultiArray(JitStruct):
...
class Int8MultiArray(JitStruct):
...
class UInt16MultiArray(JitStruct):
...
class UInt32MultiArray(JitStruct):
...
class UInt64MultiArray(JitStruct):
...
class UInt8MultiArray(JitStruct):
