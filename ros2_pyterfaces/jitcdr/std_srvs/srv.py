...
class SetBool(JitStruct):
    ...
    __unsupported_reason__ = 'event_message references unsupported message SetBool_Event'
    ...
    event_message: SetBool_Event = msgspec.field(default_factory=lambda: SetBool_Event())
...
class Trigger(JitStruct):
    ...
    __unsupported_reason__ = 'event_message references unsupported message Trigger_Event'
    ...
    event_message: Trigger_Event = msgspec.field(default_factory=lambda: Trigger_Event())
