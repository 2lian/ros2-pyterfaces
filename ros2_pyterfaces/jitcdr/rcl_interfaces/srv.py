...
from .msg import ListParametersResult, LoggerLevel, Parameter, ParameterDescriptor, ParameterValue, SetLoggerLevelsResult, SetParametersResult
...
class DescribeParameters_Response(JitStruct):
    ...
    __unsupported_reason__ = 'descriptors is a collection of messages, which cydr does not support'
    pass

class DescribeParameters(JitStruct):
    __idl_typename__ = 'rcl_interfaces/srv/DescribeParameters'
    __unsupported_reason__ = 'response_message references unsupported message DescribeParameters_Response'
    request_message: DescribeParameters_Request = msgspec.field(default_factory=DescribeParameters_Request)
    response_message: DescribeParameters_Response = msgspec.field(default_factory=DescribeParameters_Response)
    event_message: DescribeParameters_Event = msgspec.field(default_factory=lambda: DescribeParameters_Event())
...
class GetLoggerLevels_Response(JitStruct):
    ...
    __unsupported_reason__ = 'levels is a collection of messages, which cydr does not support'
    pass

class GetLoggerLevels(JitStruct):
    __idl_typename__ = 'rcl_interfaces/srv/GetLoggerLevels'
    __unsupported_reason__ = 'response_message references unsupported message GetLoggerLevels_Response'
    request_message: GetLoggerLevels_Request = msgspec.field(default_factory=GetLoggerLevels_Request)
    response_message: GetLoggerLevels_Response = msgspec.field(default_factory=GetLoggerLevels_Response)
    event_message: GetLoggerLevels_Event = msgspec.field(default_factory=lambda: GetLoggerLevels_Event())
...
class GetParameters(JitStruct):
    ...
    __unsupported_reason__ = 'response_message references unsupported message GetParameters_Response'
    request_message: GetParameters_Request = msgspec.field(default_factory=GetParameters_Request)
    response_message: GetParameters_Response = msgspec.field(default_factory=GetParameters_Response)
    event_message: GetParameters_Event = msgspec.field(default_factory=lambda: GetParameters_Event())
...
class GetParameterTypes_Response(JitStruct):
    ...
    types: types.NDArray[Any, types.UInt8] = msgspec.field(default_factory=lambda: np.empty(0, dtype=np.uint8))

class GetParameterTypes(JitStruct):
    __idl_typename__ = 'rcl_interfaces/srv/GetParameterTypes'
    __unsupported_reason__ = 'event_message references unsupported message GetParameterTypes_Event'
    request_message: GetParameterTypes_Request = msgspec.field(default_factory=GetParameterTypes_Request)
    response_message: GetParameterTypes_Response = msgspec.field(default_factory=GetParameterTypes_Response)
    event_message: GetParameterTypes_Event = msgspec.field(default_factory=lambda: GetParameterTypes_Event())
...
class ListParameters(JitStruct):
    ...
    __unsupported_reason__ = 'event_message references unsupported message ListParameters_Event'
    request_message: ListParameters_Request = msgspec.field(default_factory=ListParameters_Request)
    response_message: ListParameters_Response = msgspec.field(default_factory=ListParameters_Response)
    event_message: ListParameters_Event = msgspec.field(default_factory=lambda: ListParameters_Event())
...
class SetLoggerLevels_Response(JitStruct):
    ...
    __unsupported_reason__ = 'results is a collection of messages, which cydr does not support'
    pass

class SetLoggerLevels(JitStruct):
    __idl_typename__ = 'rcl_interfaces/srv/SetLoggerLevels'
    __unsupported_reason__ = 'request_message references unsupported message SetLoggerLevels_Request'
    request_message: SetLoggerLevels_Request = msgspec.field(default_factory=SetLoggerLevels_Request)
    response_message: SetLoggerLevels_Response = msgspec.field(default_factory=SetLoggerLevels_Response)
    event_message: SetLoggerLevels_Event = msgspec.field(default_factory=lambda: SetLoggerLevels_Event())
...
class SetParametersAtomically(JitStruct):
    ...
    __unsupported_reason__ = 'request_message references unsupported message SetParametersAtomically_Request'
    request_message: SetParametersAtomically_Request = msgspec.field(default_factory=SetParametersAtomically_Request)
    response_message: SetParametersAtomically_Response = msgspec.field(default_factory=SetParametersAtomically_Response)
    event_message: SetParametersAtomically_Event = msgspec.field(default_factory=lambda: SetParametersAtomically_Event())
...
class SetParameters(JitStruct):
    ...
    __unsupported_reason__ = 'request_message references unsupported message SetParameters_Request'
    request_message: SetParameters_Request = msgspec.field(default_factory=SetParameters_Request)
    response_message: SetParameters_Response = msgspec.field(default_factory=SetParameters_Response)
    event_message: SetParameters_Event = msgspec.field(default_factory=lambda: SetParameters_Event())
